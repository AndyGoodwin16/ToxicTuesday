...
function buildBarGraph(stat) {
    //Import JSON file.
    d3.json('../static/json/game_data.json').then((data) => {
...
function buildBarGraph2(stat) {
    //Import JSON file.
    d3.json('../static/json/pick_ban.json').then((data) => {
        //Create empty arrays to store data.
...
function buildOppTeamTable() {
    //Import JSON file.
    d3.json('../static/json/head_to_head.json').then((data) => {
...
function buildSameTeamTable() {
    //Import JSON file.
    d3.json('../static/json/same_team.json').then((data) => {
...
function buildWinrateTable() {
    //Import JSON file.
    d3.json('../static/json/winrate.json').then((data) => {
